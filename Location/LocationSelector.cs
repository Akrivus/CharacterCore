...
public class LocationSelector : MonoBehaviour, ISubGenerator
{
    ...
    public async Task<Chat> Generate(Chat chat)
    {
        ...
        var spawnPoints = await SelectSpawnPoints(chat, names, topic);
    ...
    private async Task<Dictionary<ActorContext, string>> SelectSpawnPoints(Chat chat, string[] names, string topic)
    {
